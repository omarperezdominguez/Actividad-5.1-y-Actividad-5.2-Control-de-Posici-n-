...
% 1 TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf = 490;            % Aumentamos el tiempo para que alcance a recorrer todos los puntos
ts = 0.1;           
t = 0:ts:tf;        
N = length(t);      
...
puntos = [0, 10; 3, 13; 5, 13; 5, 12; 3, 10; 2, 10; 2, 7; ...
    4, 9; 6, 9; 8, 7; 8, 11; 10, 9; 14, 9; 16, 11; 16, 5; ...
    15, 4; 13, 3; 11, 3; 9, 4; 8, 5; 8, 2; 9, 2; 9, 0; ...
    6, 0; 6, 4; 4, 4; 3, 3; 3, 2; 5, 2; 5, 0; 1, 0; 0, 6];
